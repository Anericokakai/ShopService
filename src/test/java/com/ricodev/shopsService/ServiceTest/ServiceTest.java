package com.ricodev.shopsService.ServiceTest;
...
//    create a new shop test
   ...
   public void assert_That_ShopWillBECreated(){
        ...
        Shops newShop=shops1;
        Shops savedShop=shops1;
        Mockito.when(shopRepository.save(newShop)).thenReturn(shops1);

       when(modelMapper.map(shopRequest, Shops.class)).thenReturn(shops1);
